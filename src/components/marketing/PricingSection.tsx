const PLANS = [
  ...
  },
  {
    ...
    price: '$150',
    period: '/month',
    desc: 'Our most popular plan. Inventory pulls automatically from your website or feed — no manual entry.',
    cta: 'Start Free Trial',
    features: [
      'Unlimited addendums',
    ...
    addons: [
      'iOS DA Installer App — +$10/mo',
      'SMS / QR Lead Capture — +$50/mo',
    ],
    highlight: true,
  },
  {
